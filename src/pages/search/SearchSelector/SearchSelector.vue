  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(tradList,index) in trademarkList" :key="tradList.tmId"
          @click="tradeMateHandle(tradList)">{{tradList.tmName}}</li>
          <!-- <li>TCL</li>
          <li>长虹（CHANGHONG）</li>
          <li>飞利浦（PHILIPS）</li>
          <li>风行电视</li>
  ...
  export default {
   ...
   methods:{
    ...
    this.$emit('trademarkInfo',tradList)
     ...
     this.$emit('attrInfra',attr,attrValue)
     }
   }
  }
</script>
